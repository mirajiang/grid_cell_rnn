...
options.sequence_length = 35  # number of steps per trajectory (originally 20)
...
options.Ng = 3000             # number of grid cells
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/35step3000neurontraining.png')
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/50step3000neurontraining.png')
...
options.learning_rate = 1e-4  # gradient descent learning rate
options.Np = 512              # number of place cells
options.Ng = 2000             # number of grid cells
options.place_cell_rf = 0.12  # width of place cell center tuning curve (m)
options.surround_scale = 2    # if DoG, ratio of sigma2^2 to sigma1^2
options.weight_decay = 1e-4   # strength of weight decay on recurrent weights
options.DoG = True            # use difference of gaussians tuning curves
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/35step2000neurontraining.png')
...
options.learning_rate = 1e-4  # gradient descent learning rate
options.Np = 512              # number of place cells
options.Ng = 3500             # number of grid cells
options.place_cell_rf = 0.12  # width of place cell center tuning curve (m)
options.surround_scale = 2    # if DoG, ratio of sigma2^2 to sigma1^2
options.weight_decay = 1e-4   # strength of weight decay on recurrent weights
options.DoG = True            # use difference of gaussians tuning curves
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/35step3500neurontraining.png')
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/35step2500neurontraining.png')
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/50step3500neurontraining.png')
...
plt.savefig('/home/mira/Grid_Cell_RNN/images/50step2000neurontraining.png')